                ...
                "content": [
                  {
                    ...
                    "items": [
                      {
                        "type": "text",
                        "title": "今回のデータの保存と公開について",
                        "content": "今回やっていただいた，あなたの調査・実験のデータをあなた自身で保存することが可能です。\u003Cbr\u003Eまた，今回のデータは匿名化された上でこのプログラム終了後に公開データ（オープンデータ）として保存・公開されます。それぞれの保存・公開についてのご希望をお教えください。"
                      },
                      {
                        "required": true,
                        "type": "radio",
                      ...
                      },
                      {
                        ...
                        "options": [
                          {
                            "label": "はい，オープンデータとして保存に同意します。",
                            "coding": "1"
                          },
                          {
                            "label": "いいえ，オープンデータとして保存には同意しません。",
                            "coding": "0"
                          }
                        ],
                        "name": "opendata",
                        "help": "可能な限り，公開データ（オープンデータ）として保存にご協力いただければ幸いです。"
                      },
                      {
                        "required": true,
                        "type": "html",
